...
save(scenariogrid, file="./intermediate_results/scenariogrid_simulation_study_design_1.Rda")
...
save(results, file="./intermediate_results/results_simulation_study_design_1.Rda")  
...
allfiles <- grep("res_simulation_study_design_1_", list.files("./intermediate_results/"), value=TRUE)
